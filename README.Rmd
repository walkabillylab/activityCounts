...
Please see [CHANGELOG.md](https://github.com/walkabillylab/activityCounts/blob/master/CHANGELOG.md) for a differences between the current CRAN release (0.1.2) and the development version (0.1.3). The current development version will be submitted to CRAN shortly. 
